...
export const sharedConfig = defineConfig({
  ...
  sitemap: {
    hostname: `https://web-design.weiweixu.cn${VITE_BASE_URL}`,
  },
  ...
  themeConfig: { // 主题设置
    ...
    //社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Aurorxa/web-design' },
    ],
    ...
    search: {
      ...
      options: {
        appId: 'BW18RW01T7',
        apiKey: 'a0afcb790fe34e4403843e75dc548496',
        indexName: 'web-design-weiweixu',
        locales: {
          zh: {
            placeholder: '搜索文档',
            translations: {
